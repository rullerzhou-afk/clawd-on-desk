...
- **LAN auto-discovery (mDNS)** — Clawd advertises itself on the local network as `clawd-<hostname>._clawd._tcp.local`, so companion apps can find it without a manual IP
