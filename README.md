...
> Supports Windows 11, macOS, and Ubuntu/Linux. Requires Node.js. Works with **Claude Code**, **Codex CLI**, **Copilot CLI**, **Gemini CLI**, **Cursor Agent**, **CodeBuddy**, and **CloudBase CLI**.
...
- **CodeBuddy** — [Tencent Cloud CodeBuddy](https://www.codebuddy.ai/) integration via command hooks, supporting session lifecycle, tool use, and subagent events (registered automatically when Clawd starts)
- **CloudBase CLI** — [Tencent CloudBase CLI](https://docs.cloudbase.net/cli-v1/intro) (`tcb`/`cloudbase`) process monitoring with 77 command mappings across 9 pet states
