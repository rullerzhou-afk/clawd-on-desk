...
(function initSettingsTabGeneral(root) {
  const GENERAL_IN_PLACE_KEYS = new Set([
    ...
    "sessionHudCleanupDetachedCodex",
    "allowEdgePinning",
  ...
  function render(parent) {
    ...
    parent.appendChild(helpers.buildSection(t("sectionAppearance"), [
      ...
      helpers.buildSwitchRow({
        key: "sessionHudCleanupDetachedCodex",
        labelKey: "rowSessionHudCleanupDetachedCodex",
        descKey: "rowSessionHudCleanupDetachedCodexDesc",
      }),
      buildDashboardRow(),
      helpers.buildSwitchRow({
        key: "soundMuted",
