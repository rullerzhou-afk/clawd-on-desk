...
const BUBBLE_STRINGS = {
  ...
  es: {
    ...
    switchToPlanMode: "Cambiar a modo plan",
    ...
    allow: "Permitir",
    deny: "Denegar",
    alwaysAllowBlanket: "Permitir siempre (general)",
    alwaysAllowBlanketTitle: "Advertencia: la regla 'always' de opencode aprueba automáticamente todas las llamadas de herramientas posteriores de la misma categoría en esta sesión (incluidos rm y comandos destructivos similares). La regla solo vive en memoria: reinicia opencode para revocarla.",
    needsInput: "Requiere intervención",
    ...
    chooseAtLeastOneOption: "Selección múltiple, elige al menos una",
