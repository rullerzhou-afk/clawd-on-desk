...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      rowFlashTaskbarOnComplete: "Flash taskbar on complete",
      rowFlashTaskbarOnCompleteDesc: "Flash the taskbar icon when an AI task completes, so you notice even when working in another window.",
      rowFlash: "Flash taskbar",
      rowFlashDesc: "Configure taskbar icon flashing on task completion.",
    ...
    zh: {
      ...
      rowFlashTaskbarOnComplete: "任务完成时闪烁任务栏",
      rowFlashTaskbarOnCompleteDesc: "AI 完成任务时 Windows 任务栏图标闪烁提醒，即使在其他窗口工作也能注意到。",
      rowFlash: "任务栏闪烁",
      rowFlashDesc: "设置任务完成后托盘图标的闪烁行为。",
    ...
    "zh-TW": {
      ...
      rowFlashTaskbarOnComplete: "工作完成時閃爍工作列圖示",
      rowFlashTaskbarOnCompleteDesc: "AI 完成工作時 Windows 工作列圖示閃爍提醒，即使在其他視窗工作也能注意到。",
      rowFlash: "工作列閃爍",
    ...
    ko: {
      ...
      rowFlashTaskbarOnComplete: "작업 완료 시 작업 표시줄 깜빡임",
      rowFlashTaskbarOnCompleteDesc: "AI 작업이 완료되면 Windows 작업 표시줄 아이콘이 깜빡여 다른 창에서 작업 중에도 알 수 있습니다.",
      rowFlash: "작업 표시줄 깜빡임",
    ...
    ja: {
      ...
      rowFlashTaskbarOnComplete: "タスク完了時にタスクバーを点滅",
      rowFlashTaskbarOnCompleteDesc: "AIタスクが完了するとWindowsタスクバーのアイコンが点滅し、別のウィンドウで作業していても気づけます。",
      rowFlash: "タスクバー点滅",
