...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      telegramApprovalDirectSend: "Direct Send (focus-only)",
      telegramApprovalDirectSendDesc: "When you reply to a Clawd completion notification, focus the matching local terminal. This dogfood mode does not paste text or press Enter.",
    ...
    zh: {
      ...
      telegramApprovalDirectSend: "Direct Send（仅聚焦）",
      telegramApprovalDirectSendDesc: "回复 Clawd 完成通知时，聚焦对应的本地终端。这个狗粮模式不会粘贴文本，也不会按 Enter。",
    ...
    "zh-TW": {
      ...
      telegramApprovalDirectSend: "Direct Send（僅聚焦）",
      telegramApprovalDirectSendDesc: "回覆 Clawd 完成通知時，聚焦對應的本機終端。這個試用模式不會貼上文字，也不會按 Enter。",
    ...
    ko: {
      ...
      telegramApprovalDirectSend: "Direct Send (focus-only)",
      telegramApprovalDirectSendDesc: "Clawd 완료 알림에 답장하면 해당 로컬 터미널을 포커스합니다. 이 dogfood 모드는 텍스트를 붙여넣거나 Enter를 누르지 않습니다.",
    ...
    ja: {
      ...
      telegramApprovalDirectSend: "Direct Send（フォーカスのみ）",
      telegramApprovalDirectSendDesc: "Clawd の完了通知に返信すると、対応するローカル端末をフォーカスします。この dogfood モードはテキスト貼り付けも Enter 送信もしません。",
