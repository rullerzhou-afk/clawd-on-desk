...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      mobileChannelName: "Mobile Web",
      mobileCardRunning: "LAN preview is live — open the pair URL on your phone. Read-only for now; approval actions are planned.",
      mobileCardReady: "Flip the switch below to start the LAN preview bridge.",
    ...
    zh: {
      ...
      mobileChannelName: "手机网页",
      mobileCardRunning: "局域网预览运行中——用手机打开配对 URL。目前只读，审批操作在计划中。",
      mobileCardReady: "打开下方开关即可启动局域网预览。",
    ...
    "zh-TW": {
      ...
      mobileChannelName: "手機網頁",
      mobileCardRunning: "區域網路預覽運作中——用手機開啟配對 URL。目前唯讀，核准操作規劃中。",
      mobileCardReady: "打開下方開關即可啟動區域網路預覽。",
    ...
    ko: {
      ...
      mobileChannelName: "모바일 웹",
      mobileCardRunning: "LAN 미리보기가 실행 중입니다 — 휴대폰에서 페어링 URL을 여세요. 현재 읽기 전용이며 승인 기능은 준비 중입니다.",
      mobileCardReady: "아래 스위치를 켜면 LAN 미리보기 브리지가 시작됩니다.",
    ...
    ja: {
      ...
      mobileChannelName: "モバイル Web",
      mobileCardRunning: "LAN プレビューが稼働中です — スマートフォンでペア URL を開いてください。現時点では読み取り専用で、承認操作は今後対応予定です。",
      mobileCardReady: "下のスイッチをオンにすると LAN プレビューブリッジが起動します。",
