...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      rowElicitationBubbles: "Question bubbles",
      rowElicitationBubblesDesc: "Show the desktop card when an agent asks a question (AskUserQuestion). Turn off to answer in the agent's own terminal instead. Plan review bubbles are unaffected.",
    ...
    zh: {
      ...
      rowElicitationBubbles: "提问气泡",
      rowElicitationBubblesDesc: "AI 提问（AskUserQuestion）时弹出桌面选择卡片。关掉后改在 AI 自己的终端里回答。计划审查气泡不受影响。",
    ...
    "zh-TW": {
      ...
      rowElicitationBubbles: "提問對話框",
      rowElicitationBubblesDesc: "AI 提問（AskUserQuestion）時彈出桌面選擇卡片。關掉後改在 AI 自己的終端機裡回答。計畫審查對話框不受影響。",
    ...
    ko: {
      ...
      rowElicitationBubbles: "질문 말풍선",
      rowElicitationBubblesDesc: "에이전트가 질문할 때(AskUserQuestion) 데스크톱 선택 카드를 표시합니다. 끄면 에이전트의 터미널에서 직접 답합니다. 플랜 검토 말풍선은 영향을 받지 않습니다.",
    ...
    ja: {
      ...
      rowElicitationBubbles: "質問の吹き出し",
      rowElicitationBubblesDesc: "エージェントが質問する（AskUserQuestion）ときにデスクトップの選択カードを表示します。オフにするとエージェント側のターミナルで回答します。プランレビューの吹き出しには影響しません。",
