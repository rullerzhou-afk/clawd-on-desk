...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      feishuApprovalCardReadyToEnable: "App credentials and approver are saved. Flip the switch in step 4 to start.",
      ...
      feishuApprovalStep2Title: "2. Event Subscription",
      feishuApprovalEventSubLabel: "Card callback (card.action.trigger)",
      feishuApprovalEventSubHintHtml: "In [Feishu Open Platform](https://open.feishu.cn/app), open your app → Events & Callbacks: choose the long-connection subscription method, then add the \"card.action.trigger\" (card action) callback. Do not pick the legacy card.action.trigger_v1 — it does not support long connections. If Feishu asks for a release, publish a new app version.",
      feishuApprovalStep3Title: "3. Approver",
      ...
      feishuApprovalStep4Title: "4. Enable & Test",
      ...
      feishuApprovalTestNoResponse: "The test card was sent, but no button press came back within 60 seconds. This usually means the card.action.trigger callback is not subscribed in the Feishu Open Platform — check step 2.",
      ...
      feishuApprovalPrereqLabel: "Finish steps 1 and 3 first",
    ...
    zh: {
      ...
      feishuApprovalCardReadyToEnable: "应用凭证和审批人都已保存，在第 4 步打开开关即可启动。",
      ...
      feishuApprovalStep2Title: "2. 事件订阅",
      feishuApprovalEventSubLabel: "卡片回调（card.action.trigger）",
      feishuApprovalEventSubHintHtml: "在[飞书开放平台](https://open.feishu.cn/app)打开你的应用 →「事件与回调」：订阅方式选择「使用长连接接收回调」，然后添加回调并勾选「卡片回传交互」（card.action.trigger）。注意不要选带「旧」字的 card.action.trigger_v1，它不支持长连接。如果飞书提示配置需要发版，发布一个新的应用版本即可。",
      feishuApprovalStep3Title: "3. 审批人",
      ...
      feishuApprovalStep4Title: "4. 启用与测试",
      ...
      feishuApprovalTestNoResponse: "测试卡片已发出，但 60 秒内没有收到按钮回调。通常是飞书后台没有订阅「卡片回传交互」（card.action.trigger）回调，请检查第 2 步的事件订阅。",
      feishuApprovalTestNotConnected: "飞书长连接尚未建立。请检查 App ID / App Secret 和网络后重试。",
      feishuApprovalPrereqLabel: "请先完成第 1 步和第 3 步",
