...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      rowSessionHudCleanupDetachedCodex: "Hide ended Codex sessions",
      rowSessionHudCleanupDetachedCodexDesc: "Remove detached Codex CLI sessions from the Session HUD shortly after they become idle.",
    ...
    zh: {
      ...
      rowSessionHudCleanupDetachedCodex: "隐藏已结束的 Codex 会话",
      rowSessionHudCleanupDetachedCodexDesc: "在分离的 Codex CLI 会话进入空闲后不久，将其从会话 HUD 中移除。",
    ...
    ko: {
      ...
      rowSessionHudCleanupDetachedCodex: "종료된 Codex 세션 숨기기",
      rowSessionHudCleanupDetachedCodexDesc: "분리된 Codex CLI 세션이 idle 상태가 된 직후 세션 HUD에서 제거합니다.",
    ...
    ja: {
      ...
      rowSessionHudCleanupDetachedCodex: "終了した Codex セッションを隠す",
      rowSessionHudCleanupDetachedCodexDesc: "切り離された Codex CLI セッションがアイドルになった少し後に、セッション HUD から削除します。",
