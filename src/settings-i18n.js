...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      animOverridesReplacementConfig: "Animation replacement config",
    ...
    zh: {
      ...
      animOverridesReplacementConfig: "动画替换配置",
    ...
    ko: {
      ...
      animOverridesReplacementConfig: "애니메이션 교체 설정",
    ...
    ja: {
      ...
      animOverridesReplacementConfig: "アニメ差し替え設定",
