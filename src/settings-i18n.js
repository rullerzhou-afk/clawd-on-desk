...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      animOverridesReplacementConfig: "Animation & sound replacement config",
      animOverridesOpenThemeTab: "Open Theme tab",
      animOverridesOpenAssets: "Open assets folder",
      animOverridesResetAll: "Clear all replacements",
    ...
    zh: {
      ...
      animOverridesReplacementConfig: "动画/音效替换配置",
      animOverridesOpenThemeTab: "打开主题页",
      animOverridesOpenAssets: "打开素材目录",
      animOverridesResetAll: "清除全部替换",
    ...
    ko: {
      ...
      animOverridesReplacementConfig: "애니메이션/사운드 교체 설정",
      animOverridesOpenThemeTab: "테마 탭 열기",
      animOverridesOpenAssets: "assets 폴더 열기",
      animOverridesResetAll: "모든 교체 항목 지우기",
    ...
    ja: {
      ...
      animOverridesReplacementConfig: "アニメ/サウンド差し替え設定",
      animOverridesOpenThemeTab: "テーマタブを開く",
      animOverridesOpenAssets: "assets フォルダを開く",
      animOverridesResetAll: "すべての差し替えを解除",
