...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      rowGravity: "Gravity",
      rowGravityDesc: "Dropped drags keep their momentum — Clawd falls, bounces, and lands at the bottom of the screen or on top of other windows (macOS). Idle roaming becomes a ground walk.",
    ...
    zh: {
      ...
      rowGravity: "重力",
      rowGravityDesc: "拖拽松手后保持惯性下落、弹跳，落在屏幕底部或其他窗口顶部（macOS）；漫步也会改为贴地行走。",
    ...
    "zh-TW": {
      ...
      rowGravity: "重力",
      rowGravityDesc: "拖曳鬆手後保持慣性下落、彈跳，落在螢幕底部或其他視窗頂部（macOS）；漫步也會改為貼地行走。",
    ...
    ko: {
      ...
      rowGravity: "중력",
      rowGravityDesc: "드래그를 놓으면 관성을 유지한 채 떨어지고 튕기며 화면 바닥이나 다른 창 위에 착지합니다(macOS). 배회도 바닥 걷기로 바뀝니다.",
    ...
    ja: {
      ...
      rowGravity: "重力",
      rowGravityDesc: "ドラッグを放すと勢いを保ったまま落下・バウンドし、画面下部や他のウィンドウの上に着地します（macOS）。散策も地面歩きになります。",
