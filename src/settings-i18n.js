...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      bubblePermissionDesc: "Switch controls whether Clawd shows prompts. Off sends permission and AskUserQuestion flows back to the agent terminal/TUI; Clawd never auto-approves or denies.",
    ...
    zh: {
      ...
      bubblePermissionDesc: "开关控制 Clawd 是否显示提示。关闭后权限请求和 AskUserQuestion 会回到 agent 终端 / TUI 处理；Clawd 不会自动允许或拒绝。",
    ...
    ko: {
      ...
      bubblePermissionDesc: "스위치는 Clawd가 프롬프트를 표시할지 제어합니다. 끄면 권한 요청과 AskUserQuestion 흐름이 에이전트 터미널/TUI로 돌아가며, Clawd가 자동으로 허용하거나 거부하지 않습니다.",
