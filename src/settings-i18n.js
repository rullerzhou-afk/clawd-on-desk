...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      musicAuraTitle: "Music Aura",
      musicAuraSubtitle: "Play local music and let Clawd carry a reactive particle aura while you work.",
      musicAuraKicker: "Local player",
      musicAuraNoTrack: "No track selected",
      musicAuraStatusPlaying: "Playing",
      musicAuraStatusPaused: "Paused",
      musicAuraStatusOn: "On",
      musicAuraStatusOff: "Off",
      musicAuraTrackCount: "{count} tracks",
      musicAuraPlayerTitle: "Local Player",
      musicAuraPlaylist: "Playlist",
      musicAuraPlaylistEmpty: "No tracks found. Add a music folder and rescan.",
      musicAuraPlaylistToggle: "Show playlist",
      musicAuraTrackPosition: "{current} / {count}",
      musicAuraSectionMain: "Main",
      musicAuraEnableRow: "Enable Music Aura",
      musicAuraEnableDesc: "Adds a local music player and particle visual layer to the desktop pet.",
      musicAuraAutoStart: "Auto-start playback",
      musicAuraAutoStartDesc: "Start the first local track when Clawd opens and Music Aura is enabled.",
      musicAuraContinueHidden: "Continue while pet is hidden",
      musicAuraContinueHiddenDesc: "Keep playback alive when the pet is hidden. Visuals stay tied to the pet window.",
      musicAuraSectionLibrary: "Library",
      musicAuraLibrary: "Local music folders",
      musicAuraLibraryDesc: "{count} playable tracks found. Supported: mp3, flac, wav, m4a, aac, ogg, opus.",
      musicAuraMissingDirs: "{count} folder(s) are missing.",
      musicAuraLibraryTruncated: "Scan stopped at the safety limit.",
      musicAuraRescan: "Rescan",
      musicAuraAddDirectory: "Add Folder",
      musicAuraScanFailed: "Scan failed",
      musicAuraAddDirFailed: "Could not add folder",
      musicAuraDirectories: "Folders",
      musicAuraNoDirectories: "No music folders configured.",
      musicAuraRemove: "Remove",
      musicAuraSectionPlayback: "Playback",
      musicAuraPlayback: "Controls",
      musicAuraPlaybackDesc: "Choose a folder, then use the tray menu or these controls.",
      musicAuraPreviousShort: "Prev",
      musicAuraPause: "Pause",
      musicAuraPlay: "Play",
      musicAuraNextShort: "Next",
      musicAuraVolume: "Music volume",
      musicAuraVolumeDesc: "Independent from Clawd's alert sound effects.",
      musicAuraShuffle: "Shuffle",
      musicAuraShuffleDesc: "Pick a random next track instead of strict folder order.",
      musicAuraSectionVisual: "Particle Visual",
      musicAuraVisualEnabled: "Show particle aura",
      musicAuraVisualEnabledDesc: "Render the Mineradio-style WebGL particles behind the pet.",
      musicAuraVisualStyle: "Visual style",
      musicAuraVisualStyleDesc: "Choose the 3D particle stage shape rendered around Clawd.",
      musicAuraVisualStyleHologram: "Hologram",
      musicAuraVisualStyleGalaxy: "Galaxy",
      musicAuraVisualStyleVinyl: "Vinyl Orbit",
      musicAuraVisualStylePlanet: "Planet",
      musicAuraVisualStyleTunnel: "Tunnel",
      musicAuraVisualStyleAurora: "Aurora Ribbon",
      musicAuraParticlesAlwaysOn: "Keep particles visible",
      musicAuraParticlesAlwaysOnDesc: "Keep a calm particle field alive whenever Music Aura visuals are enabled.",
      musicAuraBackgroundAdaptation: "Background adaptation",
      musicAuraBackgroundAdaptationDesc: "Improve particle readability on dark or light editor backgrounds.",
      musicAuraBackgroundAuto: "Auto",
      musicAuraBackgroundDark: "Dark",
      musicAuraBackgroundLight: "Light",
      musicAuraBackgroundContrast: "Contrast",
      musicAuraBackplateStyle: "Aura backplate",
      musicAuraBackplateStyleDesc: "Adds a local dark support layer behind the particles for readability.",
      musicAuraBackplateOff: "Off",
      musicAuraBackplateDark: "Dark",
      musicAuraBackplateStage: "Stage",
      musicAuraParticlePalette: "Particle color",
      musicAuraParticlePaletteDesc: "Choose a readable color set for dark or light coding backgrounds.",
      musicAuraPaletteDefault: "Default",
      musicAuraPaletteMineradio: "Ice White",
      musicAuraPaletteContrast: "Contrast",
      musicAuraPaletteAurora: "Aurora",
      musicAuraPaletteNeon: "Neon",
      musicAuraPaletteWarm: "Warm",
      musicAuraAutoViewMode: "Auto view",
      musicAuraAutoViewModeDesc: "Slowly shifts the camera angle to reveal more 3D depth.",
      musicAuraAutoViewOff: "Off",
      musicAuraAutoViewSubtle: "Subtle",
      musicAuraAutoViewStandard: "Standard",
      musicAuraAutoViewStrong: "Strong",
      musicAuraParticleOpacity: "Particle opacity",
      musicAuraParticleOpacityDesc: "Raises or lowers particle visibility without adding borders.",
      musicAuraGlowStrength: "Glow strength",
      musicAuraGlowStrengthDesc: "Controls the soft halo around each particle.",
      musicAuraPointScale: "Particle size",
      musicAuraPointScaleDesc: "Keeps points slim or makes them more prominent.",
      musicAuraParticleDensity: "Particle density",
      musicAuraParticleDensityDesc: "Adjusts particle count inside the current performance cap.",
      musicAuraAuraOffsetX: "Aura horizontal position",
      musicAuraAuraOffsetXDesc: "Fine-tune the particle center for the current theme ({theme}).",
      musicAuraAuraOffsetY: "Aura vertical position",
      musicAuraAuraOffsetYDesc: "Move the particle center up or down for the current theme ({theme}).",
      musicAuraAuraScale: "Aura visual scale",
      musicAuraAuraScaleDesc: "Resize the particle field for the current theme ({theme}).",
      musicAuraAuraReset: "Aura placement reset",
      musicAuraAuraResetDesc: "Clear the custom particle placement saved for {theme}.",
      musicAuraResetCurrentTheme: "Reset theme",
      musicAuraIntensity: "Intensity",
      musicAuraIntensityDesc: "Controls particle radius, speed, and brightness.",
      musicAuraIntensitySubtle: "Subtle",
      musicAuraIntensityVivid: "Vivid",
      musicAuraIntensityStage: "Stage",
      musicAuraPerformance: "Performance",
      musicAuraPerformanceDesc: "Caps the number of particles rendered around the pet.",
      musicAuraPerformanceEco: "Eco",
      musicAuraPerformanceAuto: "Auto",
      musicAuraPerformanceHigh: "High",
      musicAuraLowPerformanceProtection: "Low performance protection",
      musicAuraLowPerformanceProtectionDesc: "Automatically lowers visual load when rendering becomes heavy.",
      musicAuraStateReactive: "React to agent state",
      musicAuraStateReactiveDesc: "Working and approval states make the aura brighter and more energetic.",
      musicAuraMiniMode: "Show in mini mode",
      musicAuraMiniModeDesc: "Keep the aura visible when Clawd is tucked against the screen edge.",
      musicAuraCommandFailed: "Music Aura command failed",
    ...
    zh: {
      ...
      musicAuraTitle: "音乐光环",
      musicAuraSubtitle: "播放本地音乐，让 Clawd 在工作时带着会随频谱变化的 3D 粒子光环。",
      musicAuraKicker: "本地播放器",
      musicAuraNoTrack: "还没有选择歌曲",
      musicAuraStatusPlaying: "播放中",
      musicAuraStatusPaused: "已暂停",
      musicAuraStatusOn: "已开启",
      musicAuraStatusOff: "已关闭",
      musicAuraTrackCount: "{count} 首",
      musicAuraPlayerTitle: "本地播放器",
      musicAuraPlaylist: "播放列表",
      musicAuraPlaylistEmpty: "还没有找到歌曲。请添加音乐文件夹并重新扫描。",
      musicAuraPlaylistToggle: "展开播放列表",
      musicAuraTrackPosition: "{current} / {count}",
      musicAuraSectionMain: "主开关",
      musicAuraEnableRow: "启用音乐光环",
      musicAuraEnableDesc: "给桌宠增加本地音乐播放器和粒子可视化层。",
      musicAuraAutoStart: "启动后自动播放",
      musicAuraAutoStartDesc: "Clawd 打开且音乐光环启用时，自动播放第一首本地音乐。",
      musicAuraContinueHidden: "隐藏桌宠时继续播放",
      musicAuraContinueHiddenDesc: "桌宠隐藏时音乐继续，粒子视觉仍只跟随桌宠窗口。",
      musicAuraSectionLibrary: "音乐目录",
      musicAuraLibrary: "本地音乐文件夹",
      musicAuraLibraryDesc: "已找到 {count} 首可播放音乐。支持 mp3、flac、wav、m4a、aac、ogg、opus。",
      musicAuraMissingDirs: "{count} 个文件夹不存在。",
      musicAuraLibraryTruncated: "扫描已到安全上限。",
      musicAuraRescan: "重新扫描",
      musicAuraAddDirectory: "添加文件夹",
      musicAuraScanFailed: "扫描失败",
      musicAuraAddDirFailed: "添加文件夹失败",
      musicAuraDirectories: "文件夹",
      musicAuraNoDirectories: "还没有配置音乐文件夹。",
      musicAuraRemove: "移除",
      musicAuraSectionPlayback: "播放",
      musicAuraPlayback: "播放控制",
      musicAuraPlaybackDesc: "先添加文件夹，然后可在托盘菜单或这里控制播放。",
      musicAuraPreviousShort: "上一首",
      musicAuraPause: "暂停",
      musicAuraPlay: "播放",
      musicAuraNextShort: "下一首",
      musicAuraVolume: "音乐音量",
      musicAuraVolumeDesc: "独立于 Clawd 的提示音效音量。",
      musicAuraShuffle: "随机播放",
      musicAuraShuffleDesc: "下一首随机选择，而不是严格按文件夹顺序。",
      musicAuraSectionVisual: "粒子视觉",
      musicAuraVisualEnabled: "显示粒子光环",
      musicAuraVisualEnabledDesc: "在桌宠背后渲染 Mineradio 风格的 WebGL 粒子。",
      musicAuraVisualStyle: "视觉风格",
      musicAuraVisualStyleDesc: "选择围绕 Clawd 渲染的 3D 粒子舞台形态。",
      musicAuraVisualStyleHologram: "全息光场",
      musicAuraVisualStyleGalaxy: "星河",
      musicAuraVisualStyleVinyl: "黑胶轨道",
      musicAuraVisualStylePlanet: "星球",
      musicAuraVisualStyleTunnel: "滚筒",
      musicAuraVisualStyleAurora: "极光丝带",
      musicAuraParticlesAlwaysOn: "粒子常驻",
      musicAuraParticlesAlwaysOnDesc: "音乐光环视觉开启时，始终保留一层低速粒子氛围。",
      musicAuraBackgroundAdaptation: "背景适配",
      musicAuraBackgroundAdaptationDesc: "提升粒子在深色或浅色编辑器背景上的可读性。",
      musicAuraBackgroundAuto: "自动",
      musicAuraBackgroundDark: "深色",
      musicAuraBackgroundLight: "浅色",
      musicAuraBackgroundContrast: "高对比",
      musicAuraBackplateStyle: "光环背板",
      musicAuraBackplateStyleDesc: "在粒子后面加一层局部深色承托，让光环更清楚。",
      musicAuraBackplateOff: "关闭",
      musicAuraBackplateDark: "深色",
      musicAuraBackplateStage: "舞台",
      musicAuraParticlePalette: "粒子颜色",
      musicAuraParticlePaletteDesc: "选择适合深色或浅色编码背景的配色。",
      musicAuraPaletteDefault: "默认",
      musicAuraPaletteMineradio: "冰白",
      musicAuraPaletteContrast: "高对比",
      musicAuraPaletteAurora: "极光",
      musicAuraPaletteNeon: "霓虹",
      musicAuraPaletteWarm: "暖色",
      musicAuraAutoViewMode: "自动视角",
      musicAuraAutoViewModeDesc: "缓慢切换观察角度，让 3D 深度更明显。",
      musicAuraAutoViewOff: "关闭",
      musicAuraAutoViewSubtle: "柔和",
      musicAuraAutoViewStandard: "标准",
      musicAuraAutoViewStrong: "强",
      musicAuraParticleOpacity: "粒子透明度",
      musicAuraParticleOpacityDesc: "不加边框，只提高或降低粒子可见度。",
      musicAuraGlowStrength: "辉光强度",
      musicAuraGlowStrengthDesc: "控制每个粒子周围的柔和光晕。",
      musicAuraPointScale: "粒子尺寸",
      musicAuraPointScaleDesc: "让粒子保持细腻，或变得更明显。",
      musicAuraParticleDensity: "粒子密度",
      musicAuraParticleDensityDesc: "在当前性能档位内调整粒子数量。",
      musicAuraAuraOffsetX: "光环水平位置",
      musicAuraAuraOffsetXDesc: "微调当前主题（{theme}）的粒子中心左右位置。",
      musicAuraAuraOffsetY: "光环垂直位置",
      musicAuraAuraOffsetYDesc: "微调当前主题（{theme}）的粒子中心上下位置。",
      musicAuraAuraScale: "光环显示大小",
      musicAuraAuraScaleDesc: "调整当前主题（{theme}）的粒子覆盖范围。",
      musicAuraAuraReset: "重置光环位置",
      musicAuraAuraResetDesc: "清除 {theme} 主题保存的粒子位置微调。",
      musicAuraResetCurrentTheme: "重置当前主题",
      musicAuraIntensity: "效果强度",
      musicAuraIntensityDesc: "控制粒子的半径、速度和亮度。",
      musicAuraIntensitySubtle: "柔和",
      musicAuraIntensityVivid: "炫彩",
      musicAuraIntensityStage: "舞台",
      musicAuraPerformance: "性能",
      musicAuraPerformanceDesc: "限制桌宠周围渲染的粒子数量。",
      musicAuraPerformanceEco: "省电",
      musicAuraPerformanceAuto: "自动",
      musicAuraPerformanceHigh: "高",
      musicAuraLowPerformanceProtection: "低性能保护",
      musicAuraLowPerformanceProtectionDesc: "渲染压力变高时自动降低视觉负载。",
      musicAuraStateReactive: "跟随 Agent 状态",
      musicAuraStateReactiveDesc: "工作中和等待确认时，光环会更亮、更有能量。",
      musicAuraMiniMode: "极简模式显示",
      musicAuraMiniModeDesc: "Clawd 贴边时仍显示粒子光环。",
      musicAuraCommandFailed: "音乐光环命令失败",
      aboutTitle: "关于 Clawd",
    ...
    "zh-TW": {
      ...
      musicAuraTitle: "音樂光環",
      musicAuraSubtitle: "播放本機音樂，讓 Clawd 在工作時帶著會隨頻譜變化的 3D 粒子光環。",
      musicAuraKicker: "本機播放器",
      musicAuraNoTrack: "尚未選擇歌曲",
      musicAuraStatusPlaying: "播放中",
      musicAuraStatusPaused: "已暫停",
      musicAuraStatusOn: "已開啟",
      musicAuraStatusOff: "已關閉",
      musicAuraTrackCount: "{count} 首",
      musicAuraPlayerTitle: "本機播放器",
      musicAuraPlaylist: "播放清單",
      musicAuraPlaylistEmpty: "尚未找到歌曲。請加入音樂資料夾並重新掃描。",
      musicAuraPlaylistToggle: "展開播放清單",
      musicAuraTrackPosition: "{current} / {count}",
      musicAuraSectionMain: "主開關",
      musicAuraEnableRow: "啟用音樂光環",
      musicAuraEnableDesc: "替桌寵加入本機音樂播放器和粒子視覺層。",
      musicAuraAutoStart: "啟動後自動播放",
      musicAuraAutoStartDesc: "Clawd 開啟且音樂光環啟用時，自動播放第一首本機音樂。",
      musicAuraContinueHidden: "隱藏桌寵時繼續播放",
      musicAuraContinueHiddenDesc: "桌寵隱藏時音樂繼續，粒子視覺仍只跟隨桌寵視窗。",
      musicAuraSectionLibrary: "音樂目錄",
      musicAuraLibrary: "本機音樂資料夾",
      musicAuraLibraryDesc: "已找到 {count} 首可播放音樂。支援 mp3、flac、wav、m4a、aac、ogg、opus。",
      musicAuraMissingDirs: "{count} 個資料夾不存在。",
      musicAuraLibraryTruncated: "掃描已達安全上限。",
      musicAuraRescan: "重新掃描",
      musicAuraAddDirectory: "加入資料夾",
      musicAuraScanFailed: "掃描失敗",
      musicAuraAddDirFailed: "加入資料夾失敗",
      musicAuraDirectories: "資料夾",
      musicAuraNoDirectories: "尚未設定音樂資料夾。",
      musicAuraRemove: "移除",
      musicAuraSectionPlayback: "播放",
      musicAuraPlayback: "播放控制",
      musicAuraPlaybackDesc: "先加入資料夾，然後可在托盤選單或這裡控制播放。",
      musicAuraPreviousShort: "上一首",
      musicAuraPause: "暫停",
      musicAuraPlay: "播放",
      musicAuraNextShort: "下一首",
      musicAuraVolume: "音樂音量",
      musicAuraVolumeDesc: "獨立於 Clawd 的提示音效音量。",
      musicAuraShuffle: "隨機播放",
      musicAuraShuffleDesc: "下一首隨機選擇，而不是嚴格依資料夾順序。",
      musicAuraSectionVisual: "粒子視覺",
      musicAuraVisualEnabled: "顯示粒子光環",
      musicAuraVisualEnabledDesc: "在桌寵背後渲染 Mineradio 風格的 WebGL 粒子。",
      musicAuraVisualStyle: "視覺風格",
      musicAuraVisualStyleDesc: "選擇圍繞 Clawd 渲染的 3D 粒子舞台形態。",
      musicAuraVisualStyleHologram: "全息光場",
      musicAuraVisualStyleGalaxy: "星河",
      musicAuraVisualStyleVinyl: "黑膠軌道",
      musicAuraVisualStylePlanet: "星球",
      musicAuraVisualStyleTunnel: "滾筒",
      musicAuraVisualStyleAurora: "極光絲帶",
      musicAuraParticlesAlwaysOn: "粒子常駐",
      musicAuraParticlesAlwaysOnDesc: "音樂光環視覺開啟時，始終保留一層低速粒子氛圍。",
      musicAuraBackgroundAdaptation: "背景適配",
      musicAuraBackgroundAdaptationDesc: "提升粒子在深色或淺色編輯器背景上的可讀性。",
      musicAuraBackgroundAuto: "自動",
      musicAuraBackgroundDark: "深色",
      musicAuraBackgroundLight: "淺色",
      musicAuraBackgroundContrast: "高對比",
      musicAuraBackplateStyle: "光環背板",
      musicAuraBackplateStyleDesc: "在粒子後面加一層局部深色承托，讓光環更清楚。",
      musicAuraBackplateOff: "關閉",
      musicAuraBackplateDark: "深色",
      musicAuraBackplateStage: "舞台",
      musicAuraParticlePalette: "粒子顏色",
      musicAuraParticlePaletteDesc: "選擇適合深色或淺色程式背景的配色。",
      musicAuraPaletteDefault: "預設",
      musicAuraPaletteMineradio: "冰白",
      musicAuraPaletteContrast: "高對比",
      musicAuraPaletteAurora: "極光",
      musicAuraPaletteNeon: "霓虹",
      musicAuraPaletteWarm: "暖色",
      musicAuraAutoViewMode: "自動視角",
      musicAuraAutoViewModeDesc: "緩慢切換觀察角度，讓 3D 深度更明顯。",
      musicAuraAutoViewOff: "關閉",
      musicAuraAutoViewSubtle: "柔和",
      musicAuraAutoViewStandard: "標準",
      musicAuraAutoViewStrong: "強",
      musicAuraParticleOpacity: "粒子透明度",
      musicAuraParticleOpacityDesc: "不加邊框，只提高或降低粒子可見度。",
      musicAuraGlowStrength: "輝光強度",
      musicAuraGlowStrengthDesc: "控制每個粒子周圍的柔和光暈。",
      musicAuraPointScale: "粒子尺寸",
      musicAuraPointScaleDesc: "讓粒子保持細膩，或變得更明顯。",
      musicAuraParticleDensity: "粒子密度",
      musicAuraParticleDensityDesc: "在目前效能檔位內調整粒子數量。",
      musicAuraAuraOffsetX: "光環水平位置",
      musicAuraAuraOffsetXDesc: "微調目前主題（{theme}）的粒子中心左右位置。",
      musicAuraAuraOffsetY: "光環垂直位置",
      musicAuraAuraOffsetYDesc: "微調目前主題（{theme}）的粒子中心上下位置。",
      musicAuraAuraScale: "光環顯示大小",
      musicAuraAuraScaleDesc: "調整目前主題（{theme}）的粒子覆蓋範圍。",
      musicAuraAuraReset: "重置光環位置",
      musicAuraAuraResetDesc: "清除 {theme} 主題儲存的粒子位置微調。",
      musicAuraResetCurrentTheme: "重置目前主題",
      musicAuraIntensity: "效果強度",
      musicAuraIntensityDesc: "控制粒子的半徑、速度和亮度。",
      musicAuraIntensitySubtle: "柔和",
      musicAuraIntensityVivid: "炫彩",
      musicAuraIntensityStage: "舞台",
      musicAuraPerformance: "效能",
      musicAuraPerformanceDesc: "限制桌寵周圍渲染的粒子數量。",
      musicAuraPerformanceEco: "省電",
      musicAuraPerformanceAuto: "自動",
      musicAuraPerformanceHigh: "高",
      musicAuraLowPerformanceProtection: "低效能保護",
      musicAuraLowPerformanceProtectionDesc: "渲染壓力變高時自動降低視覺負載。",
      musicAuraStateReactive: "跟隨 Agent 狀態",
      musicAuraStateReactiveDesc: "工作中和等待核准時，光環會更亮、更有能量。",
      musicAuraMiniMode: "迷你模式顯示",
      musicAuraMiniModeDesc: "Clawd 貼邊時仍顯示粒子光環。",
      musicAuraCommandFailed: "音樂光環指令失敗",
      aboutTitle: "關於 Clawd",
    ...
    ko: {
      ...
      musicAuraTitle: "Music Aura",
      musicAuraSubtitle: "로컬 음악을 재생하고 Clawd 주변에 오디오 반응형 3D 파티클 오라를 표시합니다.",
      musicAuraKicker: "로컬 플레이어",
      musicAuraNoTrack: "선택된 트랙 없음",
      musicAuraStatusPlaying: "재생 중",
      musicAuraStatusPaused: "일시정지",
      musicAuraStatusOn: "켜짐",
      musicAuraStatusOff: "꺼짐",
      musicAuraTrackCount: "{count}곡",
      musicAuraPlayerTitle: "로컬 플레이어",
      musicAuraPlaylist: "재생 목록",
      musicAuraPlaylistEmpty: "트랙을 찾지 못했습니다. 음악 폴더를 추가하고 다시 스캔하세요.",
      musicAuraPlaylistToggle: "재생 목록 보기",
      musicAuraTrackPosition: "{current} / {count}",
      musicAuraSectionMain: "기본",
      musicAuraEnableRow: "Music Aura 활성화",
      musicAuraEnableDesc: "데스크톱 펫에 로컬 음악 플레이어와 파티클 시각화 레이어를 추가합니다.",
      musicAuraAutoStart: "자동 재생 시작",
      musicAuraAutoStartDesc: "Clawd가 열리고 Music Aura가 켜져 있으면 첫 로컬 트랙을 재생합니다.",
      musicAuraContinueHidden: "펫이 숨겨져도 계속 재생",
      musicAuraContinueHiddenDesc: "음악은 계속 재생하고, 시각 효과는 펫 창에만 표시됩니다.",
      musicAuraSectionLibrary: "라이브러리",
      musicAuraLibrary: "로컬 음악 폴더",
      musicAuraLibraryDesc: "{count}개의 재생 가능한 트랙을 찾았습니다. 지원: mp3, flac, wav, m4a, aac, ogg, opus.",
      musicAuraMissingDirs: "{count}개 폴더가 없습니다.",
      musicAuraLibraryTruncated: "안전 제한에서 스캔을 중지했습니다.",
      musicAuraRescan: "다시 스캔",
      musicAuraAddDirectory: "폴더 추가",
      musicAuraScanFailed: "스캔 실패",
      musicAuraAddDirFailed: "폴더를 추가할 수 없습니다",
      musicAuraDirectories: "폴더",
      musicAuraNoDirectories: "설정된 음악 폴더가 없습니다.",
      musicAuraRemove: "제거",
      musicAuraSectionPlayback: "재생",
      musicAuraPlayback: "컨트롤",
      musicAuraPlaybackDesc: "폴더를 선택한 뒤 트레이 메뉴나 여기에서 제어하세요.",
      musicAuraPreviousShort: "이전",
      musicAuraPause: "일시정지",
      musicAuraPlay: "재생",
      musicAuraNextShort: "다음",
      musicAuraVolume: "음악 볼륨",
      musicAuraVolumeDesc: "Clawd 알림 효과음과 독립적으로 조절됩니다.",
      musicAuraShuffle: "셔플",
      musicAuraShuffleDesc: "폴더 순서 대신 다음 트랙을 무작위로 선택합니다.",
      musicAuraSectionVisual: "파티클 비주얼",
      musicAuraVisualEnabled: "파티클 오라 표시",
      musicAuraVisualEnabledDesc: "펫 뒤에 Mineradio 스타일 WebGL 파티클을 렌더링합니다.",
      musicAuraVisualStyle: "시각 스타일",
      musicAuraVisualStyleDesc: "Clawd 주변에 렌더링할 3D 파티클 스테이지 형태를 선택합니다.",
      musicAuraVisualStyleHologram: "홀로그램",
      musicAuraVisualStyleGalaxy: "은하",
      musicAuraVisualStyleVinyl: "바이닐 오빗",
      musicAuraVisualStylePlanet: "플래닛",
      musicAuraVisualStyleTunnel: "터널",
      musicAuraVisualStyleAurora: "오로라 리본",
      musicAuraParticlesAlwaysOn: "파티클 상시 표시",
      musicAuraParticlesAlwaysOnDesc: "Music Aura 시각 효과가 켜져 있으면 잔잔한 파티클 필드를 계속 유지합니다.",
      musicAuraBackgroundAdaptation: "배경 적응",
      musicAuraBackgroundAdaptationDesc: "어둡거나 밝은 편집기 배경에서 파티클 가독성을 높입니다.",
      musicAuraBackgroundAuto: "자동",
      musicAuraBackgroundDark: "어두움",
      musicAuraBackgroundLight: "밝음",
      musicAuraBackgroundContrast: "고대비",
      musicAuraBackplateStyle: "오라 배경판",
      musicAuraBackplateStyleDesc: "파티클 뒤에 국소적인 어두운 받침을 추가해 가독성을 높입니다.",
      musicAuraBackplateOff: "끄기",
      musicAuraBackplateDark: "어두움",
      musicAuraBackplateStage: "스테이지",
      musicAuraParticlePalette: "파티클 색상",
      musicAuraParticlePaletteDesc: "어둡거나 밝은 코딩 배경에서 읽기 쉬운 색상 세트를 선택합니다.",
      musicAuraPaletteDefault: "기본",
      musicAuraPaletteMineradio: "아이스 화이트",
      musicAuraPaletteContrast: "고대비",
      musicAuraPaletteAurora: "오로라",
      musicAuraPaletteNeon: "네온",
      musicAuraPaletteWarm: "따뜻함",
      musicAuraAutoViewMode: "자동 시점",
      musicAuraAutoViewModeDesc: "카메라 각도를 천천히 바꿔 3D 깊이를 더 잘 보여줍니다.",
      musicAuraAutoViewOff: "끄기",
      musicAuraAutoViewSubtle: "은은함",
      musicAuraAutoViewStandard: "표준",
      musicAuraAutoViewStrong: "강함",
      musicAuraParticleOpacity: "파티클 불투명도",
      musicAuraParticleOpacityDesc: "테두리 없이 파티클 가시성만 높이거나 낮춥니다.",
      musicAuraGlowStrength: "글로우 강도",
      musicAuraGlowStrengthDesc: "각 파티클 주변의 부드러운 빛 번짐을 조절합니다.",
      musicAuraPointScale: "파티클 크기",
      musicAuraPointScaleDesc: "점을 얇게 유지하거나 더 두드러지게 만듭니다.",
      musicAuraParticleDensity: "파티클 밀도",
      musicAuraParticleDensityDesc: "현재 성능 한도 안에서 파티클 수를 조절합니다.",
      musicAuraAuraOffsetX: "오라 가로 위치",
      musicAuraAuraOffsetXDesc: "현재 테마({theme})의 파티클 중심을 좌우로 미세 조정합니다.",
      musicAuraAuraOffsetY: "오라 세로 위치",
      musicAuraAuraOffsetYDesc: "현재 테마({theme})의 파티클 중심을 위아래로 미세 조정합니다.",
      musicAuraAuraScale: "오라 표시 크기",
      musicAuraAuraScaleDesc: "현재 테마({theme})의 파티클 영역 크기를 조절합니다.",
      musicAuraAuraReset: "오라 위치 초기화",
      musicAuraAuraResetDesc: "{theme} 테마에 저장된 파티클 위치 조정을 지웁니다.",
      musicAuraResetCurrentTheme: "현재 테마 초기화",
      musicAuraIntensity: "강도",
      musicAuraIntensityDesc: "파티클 반경, 속도, 밝기를 제어합니다.",
      musicAuraIntensitySubtle: "은은함",
      musicAuraIntensityVivid: "선명함",
      musicAuraIntensityStage: "스테이지",
      musicAuraPerformance: "성능",
      musicAuraPerformanceDesc: "펫 주변에 렌더링할 파티클 수를 제한합니다.",
      musicAuraPerformanceEco: "절전",
      musicAuraPerformanceAuto: "자동",
      musicAuraPerformanceHigh: "높음",
      musicAuraLowPerformanceProtection: "저성능 보호",
      musicAuraLowPerformanceProtectionDesc: "렌더링 부하가 커지면 시각 효과 부하를 자동으로 낮춥니다.",
      musicAuraStateReactive: "에이전트 상태에 반응",
      musicAuraStateReactiveDesc: "작업 중과 승인 대기 상태에서 오라가 더 밝고 역동적으로 변합니다.",
      musicAuraMiniMode: "미니 모드에서 표시",
      musicAuraMiniModeDesc: "Clawd가 화면 가장자리에 있을 때도 오라를 표시합니다.",
      musicAuraCommandFailed: "Music Aura 명령 실패",
      aboutTitle: "Clawd 정보",
    ...
    ja: {
      ...
      musicAuraTitle: "Music Aura",
      musicAuraSubtitle: "ローカル音楽を再生し、Clawd の周りに音に反応する 3D パーティクルオーラを表示します。",
      musicAuraKicker: "ローカルプレイヤー",
      musicAuraNoTrack: "曲が選択されていません",
      musicAuraStatusPlaying: "再生中",
      musicAuraStatusPaused: "一時停止",
      musicAuraStatusOn: "オン",
      musicAuraStatusOff: "オフ",
      musicAuraTrackCount: "{count} 曲",
      musicAuraPlayerTitle: "ローカルプレイヤー",
      musicAuraPlaylist: "プレイリスト",
      musicAuraPlaylistEmpty: "曲が見つかりません。音楽フォルダを追加して再スキャンしてください。",
      musicAuraPlaylistToggle: "プレイリストを表示",
      musicAuraTrackPosition: "{current} / {count}",
      musicAuraSectionMain: "メイン",
      musicAuraEnableRow: "Music Aura を有効化",
      musicAuraEnableDesc: "デスクトップペットにローカル音楽プレイヤーとパーティクル表示レイヤーを追加します。",
      musicAuraAutoStart: "自動再生を開始",
      musicAuraAutoStartDesc: "Clawd 起動時に Music Aura が有効なら最初のローカル曲を再生します。",
      musicAuraContinueHidden: "ペット非表示中も再生",
      musicAuraContinueHiddenDesc: "音楽は再生を続け、表示はペットウィンドウにだけ紐づきます。",
      musicAuraSectionLibrary: "ライブラリ",
      musicAuraLibrary: "ローカル音楽フォルダ",
      musicAuraLibraryDesc: "{count} 曲の再生可能なトラックが見つかりました。対応: mp3, flac, wav, m4a, aac, ogg, opus。",
      musicAuraMissingDirs: "{count} 個のフォルダが見つかりません。",
      musicAuraLibraryTruncated: "安全上限でスキャンを停止しました。",
      musicAuraRescan: "再スキャン",
      musicAuraAddDirectory: "フォルダを追加",
      musicAuraScanFailed: "スキャンに失敗しました",
      musicAuraAddDirFailed: "フォルダを追加できません",
      musicAuraDirectories: "フォルダ",
      musicAuraNoDirectories: "音楽フォルダが設定されていません。",
      musicAuraRemove: "削除",
      musicAuraSectionPlayback: "再生",
      musicAuraPlayback: "操作",
      musicAuraPlaybackDesc: "フォルダを選んだ後、トレイメニューまたはここで操作します。",
      musicAuraPreviousShort: "前へ",
      musicAuraPause: "一時停止",
      musicAuraPlay: "再生",
      musicAuraNextShort: "次へ",
      musicAuraVolume: "音楽音量",
      musicAuraVolumeDesc: "Clawd の通知効果音とは別に調整します。",
      musicAuraShuffle: "シャッフル",
      musicAuraShuffleDesc: "フォルダ順ではなくランダムに次の曲を選びます。",
      musicAuraSectionVisual: "パーティクル表示",
      musicAuraVisualEnabled: "パーティクルオーラを表示",
      musicAuraVisualEnabledDesc: "ペットの背後に Mineradio 風の WebGL パーティクルを描画します。",
      musicAuraVisualStyle: "表示スタイル",
      musicAuraVisualStyleDesc: "Clawd の周りに描画する 3D パーティクルステージの形を選びます。",
      musicAuraVisualStyleHologram: "ホログラム",
      musicAuraVisualStyleGalaxy: "銀河",
      musicAuraVisualStyleVinyl: "レコード軌道",
      musicAuraVisualStylePlanet: "プラネット",
      musicAuraVisualStyleTunnel: "トンネル",
      musicAuraVisualStyleAurora: "オーロラリボン",
      musicAuraParticlesAlwaysOn: "パーティクルを常時表示",
      musicAuraParticlesAlwaysOnDesc: "Music Aura の表示が有効な間、穏やかなパーティクル場を維持します。",
      musicAuraBackgroundAdaptation: "背景適応",
      musicAuraBackgroundAdaptationDesc: "暗い背景や明るいエディタ背景でパーティクルを見やすくします。",
      musicAuraBackgroundAuto: "自動",
      musicAuraBackgroundDark: "暗色",
      musicAuraBackgroundLight: "明色",
      musicAuraBackgroundContrast: "高コントラスト",
      musicAuraBackplateStyle: "オーラ背板",
      musicAuraBackplateStyleDesc: "パーティクル背後に局所的な暗色レイヤーを追加して見やすくします。",
      musicAuraBackplateOff: "オフ",
      musicAuraBackplateDark: "暗色",
      musicAuraBackplateStage: "ステージ",
      musicAuraParticlePalette: "パーティクル色",
      musicAuraParticlePaletteDesc: "暗い背景や明るいコーディング背景で見やすい配色を選びます。",
      musicAuraPaletteDefault: "標準",
      musicAuraPaletteMineradio: "アイスホワイト",
      musicAuraPaletteContrast: "高コントラスト",
      musicAuraPaletteAurora: "オーロラ",
      musicAuraPaletteNeon: "ネオン",
      musicAuraPaletteWarm: "暖色",
      musicAuraAutoViewMode: "自動視点",
      musicAuraAutoViewModeDesc: "カメラ角度をゆっくり変えて 3D の奥行きを見せます。",
      musicAuraAutoViewOff: "オフ",
      musicAuraAutoViewSubtle: "控えめ",
      musicAuraAutoViewStandard: "標準",
      musicAuraAutoViewStrong: "強",
      musicAuraParticleOpacity: "パーティクル不透明度",
      musicAuraParticleOpacityDesc: "枠線を足さずにパーティクルの見やすさを上下します。",
      musicAuraGlowStrength: "グロー強度",
      musicAuraGlowStrengthDesc: "各パーティクル周辺の柔らかな光を調整します。",
      musicAuraPointScale: "パーティクルサイズ",
      musicAuraPointScaleDesc: "点を細く保つか、より目立たせるかを調整します。",
      musicAuraParticleDensity: "パーティクル密度",
      musicAuraParticleDensityDesc: "現在のパフォーマンス上限内でパーティクル数を調整します。",
      musicAuraAuraOffsetX: "オーラの横位置",
      musicAuraAuraOffsetXDesc: "現在のテーマ（{theme}）のパーティクル中心を左右に微調整します。",
      musicAuraAuraOffsetY: "オーラの縦位置",
      musicAuraAuraOffsetYDesc: "現在のテーマ（{theme}）のパーティクル中心を上下に微調整します。",
      musicAuraAuraScale: "オーラ表示サイズ",
      musicAuraAuraScaleDesc: "現在のテーマ（{theme}）のパーティクル範囲を調整します。",
      musicAuraAuraReset: "オーラ位置をリセット",
      musicAuraAuraResetDesc: "{theme} テーマに保存したパーティクル位置調整を消去します。",
      musicAuraResetCurrentTheme: "現在のテーマをリセット",
      musicAuraIntensity: "強度",
      musicAuraIntensityDesc: "パーティクルの半径、速度、明るさを制御します。",
      musicAuraIntensitySubtle: "控えめ",
      musicAuraIntensityVivid: "鮮やか",
      musicAuraIntensityStage: "ステージ",
      musicAuraPerformance: "パフォーマンス",
      musicAuraPerformanceDesc: "ペット周辺に描画するパーティクル数を制限します。",
      musicAuraPerformanceEco: "省電力",
      musicAuraPerformanceAuto: "自動",
      musicAuraPerformanceHigh: "高",
      musicAuraLowPerformanceProtection: "低負荷保護",
      musicAuraLowPerformanceProtectionDesc: "描画負荷が高い時に表示負荷を自動で下げます。",
      musicAuraStateReactive: "エージェント状態に反応",
      musicAuraStateReactiveDesc: "作業中や承認待ちではオーラが明るく、より活発になります。",
      musicAuraMiniMode: "ミニモードで表示",
      musicAuraMiniModeDesc: "Clawd が画面端にいる時もオーラを表示します。",
      musicAuraCommandFailed: "Music Aura コマンドに失敗しました",
