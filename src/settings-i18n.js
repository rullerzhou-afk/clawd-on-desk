...
(function initSettingsI18n(root) {
  const STRINGS = {
    ...
    es: {
      ...
      sidebarAnimOverrides: "Personalización de animaciones y sonido",
      sidebarShortcuts: "Atajos",
      sidebarAbout: "Acerca de",
      sidebarRemoteSsh: "SSH remoto",
      sidebarMobile: "Móvil",
      sidebarTelegramApproval: "Aprobación remota",
      remoteApprovalTitle: "Aprobación remota",
      remoteApprovalSubtitle: "Redirige las solicitudes de permiso locales a un canal remoto. Los tokens quedan fuera de prefs y el globo de escritorio sigue siendo el respaldo local. Telegram es el único canal por ahora; se planean más (Discord, …).",
      telegramApprovalChannelName: "Telegram",
      ...
      telegramApprovalCardStarting: "Conectando con el sidecar de aprobación de Telegram…",
      telegramApprovalCardRunning: "La aprobación por Telegram está activa. Las aprobaciones se enviarán a tu bot.",
      telegramApprovalCardFailed: "El sidecar reportó una falla. Revisa el mensaje de abajo o reinicia.",
      ...
      telegramApprovalCompletionOutput: "Salida al completar",
      telegramApprovalCompletionOutputDesc: "Controla si los avisos de Telegram al completar incluyen el texto del asistente. La respuesta completa puede incluir código, contenido de archivos o secretos si el asistente los escribió.",
      telegramApprovalCompletionOutput_off: "Desactivado",
      telegramApprovalCompletionOutput_full: "Respuesta completa",
      telegramApprovalCompletionOutputFullConfirm: "La respuesta completa envía el texto final del asistente a Telegram. Puede incluir código, contenido de archivos o secretos si el asistente los escribió. ¿Continuar?",
      ...
      remoteSshFieldAutoStartCodex: "Iniciar el monitor de respaldo de Codex automáticamente al conectar",
      ...
      remoteSshErrForwardFailed: "El puerto remoto no está disponible. Prueba con otro puerto de reenvío remoto (23333-23337).",
      ...
      remoteSshConnectWarnNoDeploy: "Los hooks aún no están desplegados. Conectar por sí solo únicamente crea el túnel SSH; Clawd no reaccionará a las sesiones remotas hasta que hagas clic en Desplegar / Reparar hooks.",
      ...
      doctorAgentSummaryOk: (count) => `${count} OK`,
      doctorAgentSummaryAttention: (count) => `${count} requieren atención`,
      doctorAgentSummaryNeedsAttention: "necesitan atención",
      doctorAgentSummarySkipped: (count) => `${count} omitidos`,
      ...
      sectionBubbles: "Globos",
      sectionPermissions: "Permisos",
      hardwareBuddyTitle: "Hardware Buddy",
      hardwareBuddyDesc: "Conecta un dispositivo de escritorio BLE emparejado mediante el runtime aparte de Clawstick. Las respuestas de permisos quedan desactivadas a menos que las actives explícitamente y el enlace sea seguro.",
      hardwareBuddyEnable: "Activar Hardware Buddy",
      hardwareBuddyEnableDesc: "Inicia el sidecar BLE y envía instantáneas de sesión solo de estado por defecto.",
      hardwareBuddyAddress: "Dirección BLE",
      hardwareBuddyAddressDesc: "Dirección fija del dispositivo (opcional). Déjala vacía para escanear por prefijo de nombre.",
      hardwareBuddyNamePrefix: "Prefijo del nombre del dispositivo",
      hardwareBuddyNamePrefixDesc: "Escanea dispositivos cuyo nombre anunciado empiece con este texto.",
      hardwareBuddyPermissions: "Permitir respuestas de permisos por hardware",
      hardwareBuddyPermissionsDesc: "Requiere esta activación más un transporte emparejado seguro para que aparezcan los avisos de Permitir/Denegar en el dispositivo.",
      hardwareBuddyQuickCommands: "Activar Comandos rápidos",
      hardwareBuddyQuickCommandsDesc: "Muestra botones de preajustes locales que crean eventos quick_command propios del adaptador. Clawd no pega texto ni ejecuta comandos de shell.",
      hardwareBuddyQuickCommandPresets: "Preajustes de Comandos rápidos",
      hardwareBuddyQuickCommandPresetsDesc: "Haz clic en un preajuste para encolar un evento validado para el adaptador de la sesión activa.",
      hardwareBuddyQuickCommandsDisabled: "Activa los Comandos rápidos para habilitar los botones de preajustes.",
      hardwareBuddyQuickCommandsLoading: "Cargando preajustes...",
      hardwareBuddyQuickCommandsUnavailable: "Los Comandos rápidos no están disponibles.",
      hardwareBuddyQuickCommandSent: "Comando rápido encolado.",
      hardwareBuddyQuickCommandFailed: "El comando rápido falló: ",
      hardwareBuddyRepliesOn: "Respuestas activadas",
      hardwareBuddyRepliesOff: "Respuestas desactivadas",
      hardwareBuddyRepliesBlocked: "Respuestas esperando",
      hardwareBuddyTest: "Probar aprobación",
      hardwareBuddyTestButton: "Enviar prueba",
      hardwareBuddyTestWaiting: "Esperando...",
      hardwareBuddyTestDesc: "Envía una solicitud de aprobación inofensiva al dispositivo emparejado.",
      hardwareBuddyTestPending: "Esperando que presiones un botón en el dispositivo.",
      hardwareBuddyTestOk: "El dispositivo respondió: {decision}",
      hardwareBuddyTestError: "La aprobación de prueba falló.",
      hardwareBuddyTestErr_disabled: "Hardware Buddy no está activado.",
      hardwareBuddyTestErr_permissions_off: "Las respuestas de permisos por hardware están desactivadas.",
      hardwareBuddyTestErr_not_secure: "Hardware Buddy no está conectado por un enlace seguro.",
      hardwareBuddyTestErr_timeout: "El dispositivo no respondió antes de que la prueba se agotara.",
      hardwareBuddyTestErr_no_decision: "La prueba de Hardware Buddy no recibió una decisión.",
      hardwareBuddyTestErr_internal_error: "La prueba de Hardware Buddy falló dentro de Clawd.",
      hardwareBuddyTestDisabled: "Activa Hardware Buddy antes de probar aprobaciones.",
      hardwareBuddyTestRepliesOff: "Activa las respuestas de permisos por hardware antes de probar aprobaciones.",
      hardwareBuddyTestNeedsSecure: "Conéctate por un enlace emparejado seguro antes de probar aprobaciones.",
      hardwareBuddyTestToastOk: "Se recibió la respuesta de prueba de Hardware Buddy.",
      hardwareBuddyTestToastError: "La prueba de Hardware Buddy falló: ",
      hardwareBuddyStatus: "Estado de la conexión",
      hardwareBuddyStatus_off: "Apagado",
      hardwareBuddyStatus_idle: "Inactivo",
      hardwareBuddyStatus_searching: "Buscando",
      hardwareBuddyStatus_connected: "Conectado",
      hardwareBuddyStatus_secure: "Seguro",
      hardwareBuddyStatus_error: "Necesita atención",
      hardwareBuddyStatusOffDetail: "Hardware Buddy está desactivado.",
      hardwareBuddyStatusError: "Necesita atención",
      hardwareBuddyStatusErrorDetail: "Revisa el estado del sidecar de Hardware Buddy.",
      hardwareBuddyStatusConnectedDetail: "{device} conectado, enlace seguro {secure}",
      hardwareBuddyStatusAddressDetail: "Buscando {address}.",
      hardwareBuddyStatusPrefixDetail: "Escaneando nombres que empiecen con {prefix}.",
      hardwareBuddySecureOn: "activado",
      hardwareBuddySecureOff: "desactivado",
      hardwareBuddyErr_missing_bleak: "Instala bleak",
      hardwareBuddyErr_python_missing: "Falta Python",
      hardwareBuddyErr_auth_required: "Se requiere emparejar",
      hardwareBuddyErr_device_not_found: "Dispositivo no encontrado",
      hardwareBuddyErr_bad_config: "Configuración inválida",
      hardwareBuddyErr_core_missing: "Instala Clawstick",
      hardwareBuddyErr_sidecar_exited: "El sidecar terminó",
      hardwareBuddyErr_sidecar_error: "Error del sidecar",
      collapsibleExpand: "Expandir sección",
      collapsibleCollapse: "Contraer sección",
      agentsTitle: "Agentes",
      agentsSubtitle: "Activa o desactiva el seguimiento por agente. Los agentes desactivados detienen los monitores de logs y descartan los eventos de hooks en el límite HTTP: no moverán a la mascota, no mostrarán globos de permisos ni conservarán sesiones.",
      ...
      shortcutLabelPetReveal: "Clic en la mascota: Mostrar HUD de sesión",
      ...
      sessionHudFocusUnavailableTooltip: "Enfoque de terminal no disponible",
      sessionHudRemoteFocusUnavailableTooltip: "Sesión remota: enfoque de terminal no disponible",
      ...
      rowAutoApproveAll: "Aprobar todas las solicitudes automáticamente",
      rowAutoApproveAllDesc: "PELIGRO: aprueba automáticamente cada solicitud de permiso del agente —comandos, ediciones de archivos, eliminaciones— sin preguntar. Los interruptores por agente y No molestar siguen aplicando.",
      menuAutoApproveAll: "Aprobar todas las solicitudes automáticamente",
      autoApproveAllConfirmTitle: "¿Activar aprobar todas las solicitudes automáticamente?",
      autoApproveAllConfirmDetail: "Cada solicitud de permiso de cada agente se aprobará automáticamente, incluyendo ejecutar comandos de shell y eliminar archivos. Clawd no te preguntará primero. Actívalo solo si confías plenamente en lo que hacen tus agentes.",
      ...
      bubbleNotificationDesc: "El interruptor controla los avisos pasivos de Codex / Kimi CLI. Los segundos fijan el límite máximo de cierre automático; estados de sesión posteriores pueden descartarlo antes. 0 los oculta.",
      ...
      toastAgentInstallHintPartialSkipped: "{success} instaladas. Se omitió {agents} porque no se encontró ninguna instalación local.",
      toastAgentInstallHintPartial: "{success} instaladas, {failed} fallaron: {message}",
      toastAgentCleanupHintRemoved: "Integraciones faltantes eliminadas.",
      toastAgentCleanupHintPartial: "{success} eliminadas, {failed} fallaron: {message}",
      langEnglish: "English",
      langChinese: "简中",
      langTraditionalChinese: "繁中",
      langKorean: "한국어",
      ...
      langSpanish: "Español",
      themeTitle: "Tema",
      themeSubtitle: "Elige un tema para Clawd. Las tarjetas muestran insignias integradas y de capacidad para que veas las diferencias entre rastreado, estático y mini antes de cambiar.",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) => `Codex Pets actualizados: ${imported} nuevos, ${updated} actualizados, ${unchanged} sin cambios, ${removed} eliminados${invalid ? `, ${invalid} inválidos` : ""}${switched ? "; tema activo restablecido a Clawd" : ""}.`,
      ...
      animOverridesTitle: "Personalizaciones de animación y sonido",
      ...
      aboutCleanupConfirm: "¿Quitar los hooks/plugins de Clawd de los agentes locales y marcar todas las integraciones de agentes como desinstaladas y desactivadas en Clawd? Esto no borra las apps de los agentes ni las configuraciones del usuario.",
