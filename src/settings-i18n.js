...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      rowAgentCustomHookGroup: "CodeBuddy / WorkBuddy hooks",
      rowAgentCustomHookGroupDesc: "Configure custom permission hook endpoints for the CodeBuddy-compatible tool family.",
      rowAgentCustomHookUrl: "{agent} hook URL",
      rowAgentCustomHookUrlDesc: "Optional. Leave empty to use Clawd\'s local permission hook.",
      rowAgentCustomHookUrlPlaceholder: "Default Clawd hook",
      rowAgentCustomDiscoveryGroup: "Custom discovery",
      rowAgentCustomDiscoveryGroupDesc: "Add extra install signals for any supported AI tool.",
      rowAgentCustomDiscoveryPaths: "{agent} discovery paths",
    ...
    zh: {
      ...
      rowAgentCustomHookGroup: "CodeBuddy / WorkBuddy Hook",
      rowAgentCustomHookGroupDesc: "给 CodeBuddy 兼容工具组配置自定义权限 hook 端点。",
      rowAgentCustomHookUrl: "{agent} hook 链接",
      rowAgentCustomHookUrlDesc: "可选。留空时使用 Clawd 本机权限 hook。",
      rowAgentCustomHookUrlPlaceholder: "默认 Clawd hook",
      rowAgentCustomDiscoveryGroup: "自定义发现",
      rowAgentCustomDiscoveryGroupDesc: "给任意支持的 AI 工具添加额外安装判断信号。",
      rowAgentCustomDiscoveryPaths: "{agent} 发现路径",
      rowAgentCustomDiscoveryPathsDesc: "可选。添加额外文件或文件夹作为“已安装”的判断信号；多个路径用分号分隔。",
    ...
    "zh-TW": {
      ...
      rowAgentCustomHookGroup: "CodeBuddy / WorkBuddy Hook",
      rowAgentCustomHookGroupDesc: "為 CodeBuddy 相容工具組設定自訂權限 hook 端點。",
      rowAgentCustomHookUrl: "{agent} hook 連結",
      rowAgentCustomHookUrlDesc: "可選。留空時使用 Clawd 本機權限 hook。",
      rowAgentCustomHookUrlPlaceholder: "預設 Clawd hook",
      rowAgentCustomDiscoveryGroup: "自訂發現",
      rowAgentCustomDiscoveryGroupDesc: "為任意支援的 AI 工具新增額外安裝判斷訊號。",
      rowAgentCustomDiscoveryPaths: "{agent} 發現路徑",
      rowAgentCustomDiscoveryPathsDesc: "可選。新增額外檔案或資料夾作為「已安裝」的判斷訊號；多個路徑以分號分隔。",
