...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      sidebarAbout: "About",
      sidebarCredentials: "Tokens",
      credentialsTitle: "Platform Tokens",
      credentialsHint: "Read-only. Tokens are masked — use Reveal or Copy.",
      credentialsReveal: "Reveal",
      credentialsHide: "Hide",
      credentialsCopy: "Copy",
      credentialsCopied: "Copied",
      credentialsCopyFailed: "Failed",
      credentialsNotFound: "not found",
      credentialsErrorLabel: "error",
      credentialsEdit: "Edit",
      credentialsSave: "Save",
      credentialsCancel: "Cancel",
      credentialsModel: "Model",
      credentialsBaseUrl: "Base URL",
      credentialsFetchModels: "Fetch models",
      credentialsManualModel: "Enter manually…",
      credentialsSaved: "Saved",
      credentialsSaveFailed: "Save failed",
      credentialsSaveConfirm: "This will write to the platform config file. Continue?",
      credentialsTokenKeepHint: "Leave blank to keep the current token",
      credentialsProxy: "Route through Clawd",
      credentialsProxyOn: "Proxy on",
      credentialsProxyHint: "Points this platform's base URL at Clawd's local proxy",
      usageTitle: "Usage",
      usageRealTokens: "Consumed tokens",
      usageRequests: "Requests",
      usageCost: "Total cost",
      usageInput: "New input",
      usageOutput: "Output",
      usageCacheCreate: "Cache write",
      usageCacheHit: "Cache hit",
      usageCacheRate: "Cache hit rate",
      usageByAgent: "By platform",
      usageByModel: "By model",
      usageRangeToday: "Today",
      usageRange7: "7 days",
      usageRange30: "30 days",
      usageRangeAll: "All",
      usageEmpty: "No usage recorded for this range yet.",
    ...
    zh: {
      ...
      sidebarAbout: "关于",
      sidebarCredentials: "令牌",
      credentialsTitle: "平台令牌",
      credentialsHint: "只读。令牌默认脱敏——用「显示」或「复制」。",
      credentialsReveal: "显示",
      credentialsHide: "隐藏",
      credentialsCopy: "复制",
      credentialsCopied: "已复制",
      credentialsCopyFailed: "失败",
      credentialsNotFound: "未找到",
      credentialsErrorLabel: "读取出错",
      credentialsEdit: "编辑",
      credentialsSave: "保存",
      credentialsCancel: "取消",
      credentialsModel: "模型",
      credentialsBaseUrl: "Base URL",
      credentialsFetchModels: "获取模型",
      credentialsManualModel: "手动输入…",
      credentialsSaved: "已保存",
      credentialsSaveFailed: "保存失败",
      credentialsSaveConfirm: "这会写入平台配置文件，继续？",
      credentialsTokenKeepHint: "留空则保留当前 token",
      credentialsProxy: "经 Clawd 转发",
      credentialsProxyOn: "代理已开",
      credentialsProxyHint: "把该平台 base URL 指向 Clawd 本地代理",
      usageTitle: "使用统计",
      usageRealTokens: "真实消耗 Tokens",
      usageRequests: "总请求数",
      usageCost: "总成本",
      usageInput: "新增输入",
      usageOutput: "Output",
    ...
    "zh-TW": {
      ...
      sidebarAbout: "關於",
      sidebarCredentials: "權杖",
      credentialsTitle: "平台權杖",
      credentialsHint: "唯讀。權杖預設遮蔽——用「顯示」或「複製」。",
      credentialsReveal: "顯示",
      credentialsHide: "隱藏",
      credentialsCopy: "複製",
      credentialsCopied: "已複製",
      credentialsCopyFailed: "失敗",
      credentialsNotFound: "未找到",
      credentialsErrorLabel: "讀取錯誤",
      credentialsEdit: "編輯",
      credentialsSave: "儲存",
      credentialsCancel: "取消",
      credentialsModel: "模型",
      credentialsBaseUrl: "Base URL",
      credentialsFetchModels: "取得模型",
      credentialsManualModel: "手動輸入…",
      credentialsSaved: "已儲存",
      credentialsSaveFailed: "儲存失敗",
      credentialsSaveConfirm: "這會寫入平台設定檔，繼續？",
      credentialsTokenKeepHint: "留空則保留目前 token",
      credentialsProxy: "經 Clawd 轉發",
      credentialsProxyOn: "代理已開",
      credentialsProxyHint: "將該平台 base URL 指向 Clawd 本地代理",
      usageTitle: "使用統計",
      usageRealTokens: "真實消耗 Tokens",
      usageRequests: "總請求數",
      usageCost: "總成本",
      usageInput: "新增輸入",
      usageOutput: "Output",
    ...
    ko: {
      ...
      sidebarAbout: "정보",
      sidebarCredentials: "토큰",
      credentialsTitle: "플랫폼 토큰",
      credentialsHint: "읽기 전용. 토큰은 가려져 있습니다 — 표시 또는 복사를 사용하세요.",
      credentialsReveal: "표시",
      credentialsHide: "숨기기",
      credentialsCopy: "복사",
      credentialsCopied: "복사됨",
      credentialsCopyFailed: "실패",
      credentialsNotFound: "찾을 수 없음",
      credentialsErrorLabel: "오류",
      credentialsEdit: "편집",
      credentialsSave: "저장",
      credentialsCancel: "취소",
      credentialsModel: "모델",
      credentialsBaseUrl: "Base URL",
      credentialsFetchModels: "모델 가져오기",
      credentialsManualModel: "직접 입력…",
      credentialsSaved: "저장됨",
      credentialsSaveFailed: "저장 실패",
      credentialsSaveConfirm: "플랫폼 설정 파일에 기록합니다. 계속할까요?",
      credentialsTokenKeepHint: "비워 두면 현재 토큰을 유지합니다",
      credentialsProxy: "Clawd 경유",
      credentialsProxyOn: "프록시 켜짐",
      credentialsProxyHint: "이 플랫폼의 base URL을 Clawd 로컬 프록시로 지정합니다",
      usageTitle: "사용 통계",
      usageRealTokens: "소비 토큰",
      usageRequests: "총 요청 수",
      usageCost: "총 비용",
      usageInput: "신규 입력",
      usageOutput: "출력",
      usageCacheCreate: "캐시 생성",
      usageCacheHit: "캐시 적중",
    ...
    ja: {
      ...
      sidebarAbout: "情報",
      sidebarCredentials: "トークン",
      credentialsTitle: "プラットフォームトークン",
      credentialsHint: "読み取り専用。トークンはマスクされています — 表示またはコピーを使用してください。",
      credentialsReveal: "表示",
      credentialsHide: "非表示",
      credentialsCopy: "コピー",
      credentialsCopied: "コピー済み",
      credentialsCopyFailed: "失敗",
      credentialsNotFound: "見つかりません",
      credentialsErrorLabel: "エラー",
      credentialsEdit: "編集",
      credentialsSave: "保存",
      credentialsCancel: "キャンセル",
      credentialsModel: "モデル",
      credentialsBaseUrl: "Base URL",
      credentialsFetchModels: "モデルを取得",
      credentialsManualModel: "手動入力…",
      credentialsSaved: "保存しました",
      credentialsSaveFailed: "保存に失敗",
      credentialsSaveConfirm: "プラットフォームの設定ファイルに書き込みます。続けますか？",
      credentialsTokenKeepHint: "空欄にすると現在のトークンを保持します",
      credentialsProxy: "Clawd 経由",
      credentialsProxyOn: "プロキシ有効",
      credentialsProxyHint: "このプラットフォームの base URL を Clawd のローカルプロキシに向けます",
      usageTitle: "使用統計",
      usageRealTokens: "消費トークン",
      usageRequests: "リクエスト数",
      usageCost: "総コスト",
      usageInput: "新規入力",
      usageOutput: "出力",
      usageCacheCreate: "キャッシュ作成",
      usageCacheHit: "キャッシュヒット",
      usageCacheRate: "キャッシュヒット率",
      usageByAgent: "プラットフォーム別",
      usageByModel: "モデル別",
      usageRangeToday: "今日",
      usageRange7: "直近7日",
      usageRange30: "直近30日",
      usageRangeAll: "全期間",
      usageEmpty: "この期間の使用記録はまだありません。",
