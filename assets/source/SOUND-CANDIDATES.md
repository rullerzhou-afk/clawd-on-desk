# Bundled Sound Candidates

These CC0 files are retained as the reviewed source set for the built-in task
completion sound. Only the active default is copied into the packaged runtime;
the other candidates remain under `assets/source/` for future selection.
...
Individual directories record the page URL, source metadata, retrieval date,
and SHA-256 digest.
