...
> 支持 Windows 11 和 macOS。需要 Node.js。支持 **Claude Code**、**Codex CLI**、**Copilot CLI** 和 **OpenCode/Crush**。
...
- **OpenCode/Crush** — 通过 `opencode.json` 配置 plugin 集成
- **多 Agent 共存** — 所有 Agent 可同时运行，Clawd 独立追踪每个会话
