...
// mimocode SDK ≥1.15.13: event.properties.info.parentID (Session.parentID).
...
// normalizeMimocodeSessionId() so raw ("ses_child") and prefixed
// ("mimocode:ses_child") forms match consistently.
